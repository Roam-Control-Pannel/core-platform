...
const env: ApiEnv = {
  ...
  cj: { token: null, websiteId: null, baseUrl: "https://link-search.api.cj.com", advertiserIds: "joined", linkType: null, promotionType: null, promotionalOnly: true, region: "GB", debug: false },
